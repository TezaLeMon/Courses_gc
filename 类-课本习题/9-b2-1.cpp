...
public:
	...
	{
		double a, b, c, p, s;
		a = sqrt(fabs(p1.getx() - p2.getx())*fabs(p1.getx() - p2.getx()) + fabs(p1.gety() - p2.gety())*fabs(p1.gety() - p2.gety()));
		b = sqrt(fabs(p1.getx() - p3.getx())*fabs(p1.getx() - p3.getx()) + fabs(p1.gety() - p3.gety())*fabs(p1.gety() - p3.gety()));
		c = sqrt(fabs(p3.getx() - p2.getx())*fabs(p3.getx() - p2.getx()) + fabs(p3.gety() - p2.gety())*fabs(p3.gety() - p2.gety()));
