...
//	}
//
//	gotoxy(0, 0);//光标回到窗口最左上方（此句不能省略，否则显示位置不正确）
//	/* 如果有滚动条，给出提示 */
...
//		for (y = 2; y < MAX_Y; y++) {
//			/* 在坐标(x,2)位置处连续打印10个字符 */
//			showstr(X, y, "ABCDE", bg_color, fg_color, 2);
//
//			/* 延时0.3秒 */
//			Sleep(300);
//
...
//
//		/* 改变输出窗口的大小 */
//		setconsoleborder(85, 33, 120, 150);
...
//
//		setconsoleborder(cur_cols, cur_lines, cur_buffer_cols, cur_buffer_lines);
...
//	if (1) {
//		char cur_title[256];
//		getconsoletitle(cur_title, sizeof(cur_title));
//		cout << endl << endl << "当前窗口标题：" << cur_title << endl;
//		to_be_continued("窗口标题读取完成");
//
//		setconsoletitle("测试标题名Hello");
...
//
//		/* 设置新宋体，28点阵 */
//		setconsoleborder(60, 25);
//		setfontsize("新宋体", 28); //Truetype字体只需要给出一个参数高度即可
...
//		int i;
//
//		setconsoleborder(w, h);		//说明：屏幕显示横高比大约2:1，因此600*300像正方形
//
...
//			gotoxy(point_x + x * 2, point_y + y);	//x*2是因为长宽比
//			cout << '*';
//			Sleep(1);
//		}
//
...
//		setconsoleborder(120, 30, 120, 9001);
